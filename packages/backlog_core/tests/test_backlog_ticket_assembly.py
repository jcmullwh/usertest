...
def _selection(pid: str) -> dict[str, Any]:
    ...
    selection = {
        ...
        "falsification_review": {
            ...
            "evidence_refs": [
                {
                    "ref": verification["mechanism_evidence"][0][
            ...
            "outcome_contract_reviews": [
                {
                    ...
                    "evidence_refs": [
                        verification["mechanism_evidence"][0][
                            "mechanism_evidence_id"
                        ]
                    ],
                }
...
def _research_proof(pid: str, **overrides: object) -> dict[str, Any]:
    ...
    if "evidence_verification" not in overrides:
            ...
            "hypothesis_refs": [
                {
                    ...
                    "disposition_evidence_refs": hypothesis[
        ...
        mechanism_evidence = {
            ...
            "strong_pytest_control_id": control_receipt[
        ...
        verification["hypothesis_refs"][0]["falsification_attempts"] = [
            {
                ...
                "intervention_receipt_id": intervention[
        ...
        failure_path["failure_path_id"] = "failure_path:" + _canonical_sha256(
            failure_path
        )
...
def test_generic_tests_cannot_substitute_for_recurrence_role() -> None:
    ...
    assert tickets[0]["stage"] == "research_required"
    assert "change_plan_outcome_role_reuses_generic_verification:recurrence" in tickets[0][
        "ticket_readiness"
    ]["reasons"]
